...
const CSidebarHeader = React.forwardRef((_a, ref) => {
    var { children, className } = _a, rest = tslib_es6.__rest(_a, ["children", "className"]);
    return (React.createElement("div", Object.assign({ className: index.default('sidebar-header', className), ref: ref }, rest), children));
});
