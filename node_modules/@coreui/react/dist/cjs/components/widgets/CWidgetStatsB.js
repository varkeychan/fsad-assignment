...
const CWidgetStatsB = React.forwardRef((_a, ref) => {
    var { className, color, inverse, progress, text, title, value } = _a, rest = tslib_es6.__rest(_a, ["className", "color", "inverse", "progress", "text", "title", "value"]);
    return (React.createElement(CCard.CCard, Object.assign({ className: className, color: color }, (inverse && { textColor: 'white' }), rest, { ref: ref }),
        React.createElement(CCardBody.CCardBody, null,
            ...
            React.createElement(CProgress.CProgress, Object.assign({ className: "my-2", height: 4 }, (inverse && { white: true }), progress)),
