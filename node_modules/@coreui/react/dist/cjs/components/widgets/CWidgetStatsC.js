...
const CWidgetStatsC = React.forwardRef((_a, ref) => {
    var { className, color, icon, inverse, progress, title, value } = _a, rest = tslib_es6.__rest(_a, ["className", "color", "icon", "inverse", "progress", "title", "value"]);
    return (React.createElement(CCard.CCard, Object.assign({ className: className, color: color }, (inverse && { textColor: 'white' }), rest, { ref: ref }),
        React.createElement(CCardBody.CCardBody, null,
            ...
            React.createElement(CProgress.CProgress, Object.assign({ className: "mt-3 mb-0", height: 4 }, (inverse && { white: true }), progress)))));
});
